...
public final class Constants {
    ...
    public static final class DriveConstants{
        ...
        public static final double kTrackwidthMeters = 0.69; //need to measure trackwidth, or characterize drive
        ...
        public static final double kMetersPerRotation = 9; //value will need to be calculated again
        public static final double kSensorUnitsPerRotation = 4096; //value will need to be found
    }
}